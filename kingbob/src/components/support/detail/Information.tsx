...
const Information = () => {
    ...
    const {
        onOpen: openTransferTicketModal,
        ...
        <>
            <Card>
                            ...
                            <Text>
                                : {
                                    ticketAssigned
                                        ...
                                        : <Button size="sm" colorScheme={"green"} onClick={openAssignTicketModal}>Assign Someone</Button>
                                }
                            </Text>
                        </SimpleGrid>
                    </Flex>
                ...
                <Flex align={"center"} justify={"center"} gap={2}>
                    <Button colorScheme={"yellow"} onClick={openTransferTicketModal}>Transfer ticket</Button>
