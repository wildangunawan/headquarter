...
import { Table, Thead, Tr, Th, Tbody, Td, Text, Box, useColorModeValue, Link, Button, Menu, MenuButton, MenuItem, MenuList, Flex } from "@chakra-ui/react";
        ...
        <>
            <Card>
                <Flex>
                    ...
                    <Button colorScheme={"blue"} onClick={onOpen}>Request for a position</Button>
                </Flex>
                        ...
                        <Tbody>
                            <Tr>
                                ...
                                <Td>
                                    <Menu>
                                        ...
                                        <MenuList>
                                            <MenuItem>Approve (keep requested position and time)</MenuItem>
                            ...
                            <Tr>
                                ...
                                <Td
                                    ...
                                    color="teal.50"
                                    maxW={"20ch"}
                                >Approved with changes by Gru (1000005)</Td>
                                <Td>
                                    <Menu>
                                        <MenuButton as={Button} rightIcon={<ChevronDownIcon />}>
                                            Actions
