        ...
        {showMePls ? (
          <VStack divider={<StackDivider />} spacing={4}>
            <VStack textAlign={"center"} spacing={2}>
              ...
              <Text>
                Your instructor/mentor gave 2 comments for this session.
              </Text>
            </VStack>
            <Link as={NextLink} href={"/training/me"} color={"blue.500"}>
              <>
          ...
          <Text>
            You don&apos;t have any training recorded in the system yet.
          </Text>
        )}
      </Center>
    </Card>
