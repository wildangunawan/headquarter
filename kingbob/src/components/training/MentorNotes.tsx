        ...
        <Center h={"100%"} w={"100%"} my="1em" px="15px" py="10px">
          {showMePls ? (
                  ...
                  <Tr>
                    ...
                    <Td>
                      <Text>
                        ...
                        elit. Delectus praesentium optio harum laudantium ipsam
                        earum! Dolore esse magnam sint quasi! Enim facilis
                        aperiam laboriosam sit amet explicabo iusto, natus
                        perspiciatis.
                      </Text>
                    </Td>
            ...
            <Text>
              ...
              {viewingMyself ? "you" : "this student"}.
            </Text>
          )}
        </Center>
      </Card>
