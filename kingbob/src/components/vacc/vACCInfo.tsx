        ...
        <Card>
            ...
            >
                ...
                >
                    <Text>Website</Text>
                    <Text>
                        <NavLink href="https://idvacc.id" passHref>
                            <Link color="brand.500">https://idvacc.id</Link>
                        </NavLink>
                    </Text>
                </Grid>
                <Grid
                ...
                >
                    ...
                    <Text>
                        <NavLink href="mailto:humas@idvacc.id" passHref>
                            <Link color="brand.500">humas@idvacc.id</Link>
                        </NavLink>
                    </Text>
                </Grid>
                <Grid
