            ...
            <Table variant="simple">
              ...
              <Tbody>
                <Tr>
                  ...
                  <Td>
                    <Link
                      href="https://vats.im/idn/wadd-sop"
                      as={NextLink}
                      color="brand.500"
                    >
                      https://vats.im/idn/wadd-sop
                    </Link>
                  </Td>
                  <Td>SOP</Td>
                  <Td>
                ...
                <Tr>
                  ...
                  <Td>
                    <Link
                      href="https://vats.im/idn/wiii-sop"
                      as={NextLink}
                      color="brand.500"
                    >
                      https://vats.im/idn/wiii-sop
                    </Link>
                  </Td>
                  <Td>SOP</Td>
                  <Td>
                ...
                <Tr>
                  ...
                  <Td>
                    <Link
                      href="https://vats.im/idn/discord"
                      as={NextLink}
                      color="brand.500"
                    >
                      https://vats.im/idn/discord
                    </Link>
                  </Td>
                  <Td>Miscellaneous</Td>
                  <Td>
...
CharSceCtor.getLayout = (page: ReactElement) => (
  <AdminLayout title="CharSceCtor">{page}</AdminLayout>
);
