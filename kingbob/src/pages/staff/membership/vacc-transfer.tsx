...
import { Link, VStack, Flex, Button, Alert, AlertIcon, TableContainer, Table, Thead, Tr, Th, Tbody, Td, useColorModeValue, Text, Menu, MenuButton, MenuItem, MenuList } from "@chakra-ui/react";
                        ...
                        <Table variant='simple'>
                            ...
                            <Tbody>
                                <Tr>
                                    ...
                                    <Td>
                                        <NavLink href="/profile/1000000" passHref>
                                            <Link color="brand.500">Kevin</Link>
                                        </NavLink>
                                    </Td>
                                    <Td>1000000</Td>
                                    ...
                                    <Td bg="orange" color="white">Pending</Td>
                                    <Td>
                                        <Menu>
                                ...
                                <Tr>
                                    ...
                                    <Td>
                                        <NavLink href="/profile/1000002" passHref>
                                            <Link color="brand.500">King Bob</Link>
                                        </NavLink>
                                    </Td>
                                    <Td>1000002</Td>
                                    <Td>Malaysia vACC</Td>
                                ...
                                <Tr>
                                    ...
                                    <Td bg="green" color="white">Done</Td>
                                    <Td></Td>
                                </Tr>
                                <Tr>
                                    <Td>2 - have rating</Td>
                                    ...
                                    <Td bg="red" color="white">Rejected</Td>
                                    <Td></Td>
                                </Tr>
                            </Tbody>
                        </Table>
...
VACCTransfer.getLayout = (page: ReactElement) => <AdminLayout title="vACC Transfer">{page}</AdminLayout>
